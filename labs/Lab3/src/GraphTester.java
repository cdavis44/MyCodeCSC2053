...
public class GraphTester {
	 ...
	 * @return
	 */
	private static boolean isPathBFS(GraphInterface<String> graph, String startVertex, String endVertex) {
	...
	public static void main(String[] args) {
		...
		System.out.println("Are Jack and Cathy indirect friends?: " + isPathBFS(graph, "Jack", "Cathy"));
		System.out.println("Are Jack and George indirect friends?: " + isPathBFS(graph, "Jack", "George"));
	}
