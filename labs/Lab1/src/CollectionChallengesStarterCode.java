...
public class CollectionChallengesStarterCode {
		...
		public static Map<String, Integer> wordCount(String[] strings) {
			  HashMap<String, Integer> eleMap = new HashMap<>();
			  for(String letter: strings) {
				  if(!eleMap.containsKey(letter))
					  eleMap.put(letter, 1);
				  else {
					  int num = eleMap.get(letter);
					  eleMap.put(letter, num+1);
				  }
			  }
			 return eleMap;
